...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', type=str, default='celeba_hq_test_sample.jpg',
                        help='Filename of generated big sample image')
    parser.add_argument('--make_video', type=int, default=0,
                        help='Make a sampling video also')
    parser.add_argument('--latent_sample_per_domain', type=int, default=1,
                        help='Number of generated images per domain during sampling')
